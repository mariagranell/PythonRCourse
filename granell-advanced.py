...
# to check the length of the sequences. https://stackoverflow.com/questions/5904969/how-to-print-a-dictionarys-key
...
# to print the table! https://stackoverflow.com/questions/18746278/building-a-table-from-python-nested-dictionaries-with-missing-values
